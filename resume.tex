...
% CONTACT INFORMATION
%====================
\def\name{JC Arbelbide} % Name Here
\def\phone{(925) 783-1445}
\def\city{Santa Clara, CA}
\def\email{jcarbelbide@gmail.com}
\def\LinkedIn{jcarbelbide} % linkedin.com/in/______
\def\github{jcarbelbide} % github username
